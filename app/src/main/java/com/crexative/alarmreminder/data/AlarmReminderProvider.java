...
public class AlarmReminderProvider extends ContentProvider {
    ...
    private static final int REMINDER = 100; // All
    private static final int REMINDER_ID = 101; //Single

    private static final UriMatcher sUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);

    static {
        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITHY, AlarmReminderContract.PATH_VEHICLE, REMINDER);
        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITHY, AlarmReminderContract.PATH_VEHICLE + "/#", REMINDER);
    }
    ...
    public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        switch (match){
            ...
            case REMINDER_ID:
                ...
                default:
                    throw new IllegalArgumentException("Update os not supported for "+ uri);
        }
    }
    ...
    private int updateReminder(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs){
        ...
        int rowsUpdate = database.update(AlarmReminderContract.AlarmReminderEntry.TABLE_NAME,
